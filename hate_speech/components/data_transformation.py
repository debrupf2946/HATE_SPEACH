...
class DataTransformation:
    ...
    def imbalance_data_cleaning(self):
        ...
        logging.info("Exited from imbalance_data_cleaning method of DataTransformation class")
        return imbalance_data
    
    def raw_data_cleaning(self):
        logging.info("Entered into raw_data_cleaning method of DataTransformation class")
